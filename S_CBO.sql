WITH LocalStats AS (
    SELECT /*+ ALL_ROWS */ 'Transilvania' AS regiune, s.nume AS nume_sala, o.nume_oras,
    ...
    SELECT /*+ ALL_ROWS */ 'Muntenia' AS regiune, s.nume AS nume_sala, o.nume_oras,
           COUNT(DISTINCT e.id_eveniment) AS nr_evenimente,
           COUNT(b.id_bilet) AS total_bilete,
           SUM(b.pret) AS venit_total,
           (SELECT COUNT(a.id_angajat) 
    ...
    SELECT /*+ ALL_ROWS */ 'Moldova' AS regiune, s.nume AS nume_sala, o.nume_oras,
           COUNT(DISTINCT e.id_eveniment) AS nr_evenimente,
           COUNT(b.id_bilet) AS total_bilete,
           SUM(b.pret) AS venit_total,
           (SELECT COUNT(a.id_angajat) 
